...
export const EMBED_MODEL = env("EMBED_MODEL", cfg.embedder?.model || LLM_MODEL);
export const EMBED_BASE = env("EMBED_BASE_URL", cfg.embedder?.base_url || LLM_BASE);
export const EMBED_KEY = env("EMBED_API_KEY", cfg.embedder?.api_key || LLM_KEY);
